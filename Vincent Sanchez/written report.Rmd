...
The GitHub repository with the code from this project can be found [here](https://github.com/the-codingschool/DSRP-2023-DiDonato/tree/dev-VS) (under the `Vincent Sanchez` folder).
